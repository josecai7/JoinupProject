...
namespace Joinup.Utils
{
    public class IconUtils
    {
        ...
        protected Dictionary<string, char> mFontAwesomeNames = null;

        public IconUtils()
        {
            InitializeFontAwesomeNames();
        }

        protected void InitializeFontAwesomeNames()
        {
            mFontAwesomeNames = new Dictionary<string, char>
            {
                { "access-point", '\uf002' },
...
{ "zodiac-virgo", '\ufa87' },
        ...
        public string GetIcon(string pIconName)
        {
            string icon = GetIconFromDict( pIconName, mFontAwesomeNames );
        ...
        protected string GetIconFromDict(string pIconName, Dictionary<string, char> pIconDict)
        {
            return !string.IsNullOrEmpty( pIconName ) && pIconDict.ContainsKey( pIconName ) ? pIconDict[pIconName].ToString() : "";
        }
    }
}